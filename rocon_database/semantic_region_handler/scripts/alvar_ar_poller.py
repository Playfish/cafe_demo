...
if __name__ == '__main__':
    ...
    ar_marker_pub = rospy.Publisher('marker_pose_list',AlvarMarkers,latch=True, queue_size=5)
    viz_marker_pub = rospy.Publisher('viz_ar_list',MarkerArray,latch=True, queue_size=5)
