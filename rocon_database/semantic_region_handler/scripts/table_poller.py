...
if __name__ == '__main__':
    ...
    marker_pub = rospy.Publisher('table_marker',MarkerArray,latch=True, queue_size=5)
    table_pub = rospy.Publisher('table_pose_list',TablePoseList,latch=True, queue_size=5)
