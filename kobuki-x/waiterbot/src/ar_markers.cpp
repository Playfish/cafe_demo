...
void ARMarkers::globalMarkersCB(const ar_track_alvar_msgs::AlvarMarkers::ConstPtr& msg)
{
...
void ARMarkers::arPoseMarkersCB(const ar_track_alvar_msgs::AlvarMarkers::ConstPtr& msg)
{
...
//                  << marker.stability << "   "<< marker.persistence << position << "   " << "   " << marker.obs_list_.size());
    ...
    ar_track_alvar_msgs::AlvarMarker global_marker;
...
bool ARMarkers::closest(const ar_track_alvar_msgs::AlvarMarkers& including,
                           const ar_track_alvar_msgs::AlvarMarkers& excluding,
                                  ar_track_alvar_msgs::AlvarMarker& closest)
{
