...
public:
  ...
  bool spotted(double younger_than,
               const ar_track_alvar_msgs::AlvarMarkers& including, const ar_track_alvar_msgs::AlvarMarkers& excluding,
               ar_track_alvar_msgs::AlvarMarkers& spotted_markers);
  bool closest(const ar_track_alvar_msgs::AlvarMarkers& including, const ar_track_alvar_msgs::AlvarMarkers& excluding,
...
private:
  ...
  ar_track_alvar_msgs::AlvarMarkers global_markers_;  /**< AR markers described in the semantic map */
  ...
  bool included(const uint32_t id, const ar_track_alvar_msgs::AlvarMarkers& v,
